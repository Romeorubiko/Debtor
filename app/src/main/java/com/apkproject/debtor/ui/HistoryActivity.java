...
public class HistoryActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.my_debts_drawer) {
            intent = new Intent(HistoryActivity.this, MyListsActivity.class);
            pressed = true;
        }  else if (id == R.id.contacts_drawer) {
            intent = new Intent(HistoryActivity.this, ContactListActivity.class);
            pressed = true;
        } else if (id == R.id.sync_drawer) {
            //todo intent = new Intent(MyListsActivity.this, SyncActivity.class);
        } else if (id == R.id.settings_drawer) {
            intent = new Intent(HistoryActivity.this, AccountActivity.class);
            pressed = true;
        } else if (id == R.id.notifications_drawer) {
            intent = new Intent(HistoryActivity.this, NotificationsActivity.class);
            pressed = true;
        }
